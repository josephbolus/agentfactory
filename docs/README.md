...
Start with the root [README](../README.md) to run Agent Factory.
...
- [Repository workflow routing](repository-workflow-routing/design.md):
  versioned Markdown workflows, GitHub label routing, snapshots, and safety
  boundaries.
- [Repository workflows](workflows/repository-workflows.md): authoring
  frontmatter, routing examples, workflow roles, and the GitHub issue loop.
...
- Internal pull requests from Owens OnLine employees are welcome.
...
- [Agent Factory vision](software-factory/vision.md): product thesis, scope,
