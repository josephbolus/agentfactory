...
type TaskSnapshot struct {
	...
	Generation          int                                   `json:"generation"`
	OutcomeContract     OutcomeContract                       `json:"outcome_contract"`
	Workflow            RepositoryWorkflowSnapshot            `json:"workflow,omitempty"`
	RepositoryWorkflows map[string]RepositoryWorkflowSnapshot `json:"repository_workflows,omitempty"`
