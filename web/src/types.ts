...
export interface TaskSnapshot {
  ...
  execution_profile_id?: string;
  workflow_id?: string;
  workflow?: RepositoryWorkflowSnapshot;
  timeout_seconds: number;
  concurrency_limit: number;
  generation: number;
  repositories: TaskRepository[] | null;
...
export interface RepositoryWorkflowSnapshot extends RepositoryWorkflow {
  instructions: string;
}

export interface RepositoryWorkflowDiagnostic {
  issue_number: number;
  issue_url: string;
  code: string;
  message: string;
...
export interface RepositoryWorkflowCatalog {
  repository_id: string;
  repository_identity: string;
  commit_sha: string;
  ...
  diagnostics?: RepositoryWorkflowDiagnostic[];
}

export interface RepositoryWorkflowOption {
  id: string;
  title: string;
  description?: string;
  repository_count: number;
