import { Anvil, Bot, Columns3, Gauge, GitBranch, GitMerge, Menu, Plus, Repeat2, X } from "lucide-react";
...
export function App() {
  ...
  return <div className="app-shell">
    <aside className={`sidebar ${mobileNavOpen ? "sidebar-open" : ""}`}>
      <div className="brand"><div className="brand-mark" aria-hidden="true"><Anvil size={18} strokeWidth={2.2} /></div><div><span className="brand-name">Agent Factory</span><span className="brand-subtitle">control plane</span></div></div>
